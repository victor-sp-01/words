...
const FormWordShare = async ( { type = true, id = false } )=>{
    const [ modalElement ] = ModalOption(`
        ...
        <input type="text" class="input__vbkD7" name="name" placeholder="escriba una palabra" readonly>
        <div class="div__COvt4" >
            ${ !type ? `
                <button type="button" class="button__qnn3R after icon" id="btnShareOpen" ><i class="fa-solid fa-globe"></i></button> 
                <button type="button" class="button__qnn3R after icon" id="btnDeleteShare" ><i class="fa-solid fa-trash"></i></button> 
            ` : '' }
        </div>
    `)

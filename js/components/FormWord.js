...
const FormWord = async ( { type = true, id = false } )=>{
    const [ modalElement ] = ModalOption(`
        ...
        <input type="text" class="input__vbkD7" name="name" placeholder="escriba una palabra" >
        <div class="div__COvt4" >
            ${ !type ? `
                <button type="button" class="button__qnn3R after icon" id="btnShare" ><i class="fa-solid fa-share-nodes"></i></button> 
